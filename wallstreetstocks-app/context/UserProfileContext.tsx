...
export function UserProfileProvider({ children }: { children: React.ReactNode }) {
  ...
  // Fetch profile when auth user ID changes (login/logout) or auth finishes loading
  // NOTE: Do NOT include authUser?.name or authUser?.username as dependencies!
  // Those change when we update profile locally, which would trigger a re-fetch
  // from API and overwrite our local update with stale replica data.
  useEffect(() => {
