  ...
  return (
    <main className="min-h-screen bg-night text-ivory flex flex-col items-center py-14 px-6">
      ...
      <div className="grid md:grid-cols-3 gap-6 max-w-5xl w-full mb-14">
        ...
        >
          <h3 className="text-xl font-semibold mb-2 text-gray-100">Annualized Return</h3>
          <p className="text-3xl font-bold text-gold">+22.7%</p>
        ...
        <motion.div
          ...
          className="bg-surface2 border border-white/10 rounded-2xl shadow-md p-6 text-center"
        >
          <h3 className="text-xl font-semibold mb-2 text-gray-100">Max Drawdown</h3>
          <p className="text-3xl font-bold text-gold">-7.9%</p>
