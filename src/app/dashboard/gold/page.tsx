...
export default function GoldDashboardPage() {
  return (
    <section className="max-w-6xl mx-auto pt-10 py-16 px-6">
      {/* Header */}
      <div className="text-center mb-12">
        <Trophy className="w-12 h-12 text-yellow-400 mx-auto mb-4" />
        <h1 className="text-4xl text-ivory mb-3 font-display font-normal tracking-tight md:text-5xl">
          Gold Plan Dashboard
        </h1>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        {/* AI Stock Picks */}
        <div className="bg-surface p-6 rounded-2xl shadow-md border border-white/10 hover:shadow-lg transition">
        ...
        <div className="bg-gradient-to-r from-yellow-400 to-yellow-500 rounded-2xl p-6 text-center shadow text-black">
          ...
          <Link
            href="/plans"
            className="inline-block bg-black text-yellow-400 font-semibold px-5 py-2 rounded-lg hover:bg-white/10 transition"
          >
            Upgrade Now →
          </Link>
        </div>
      ...
      <div className="mt-12 text-center">
        <Link href="/" className="text-gray-500 hover:text-gold text-sm">
          ← Back to Home
        </Link>
      </div>
    </section>
