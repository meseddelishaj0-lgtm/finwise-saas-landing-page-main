...
export default function Page() {
  ...
  return (
    <main className="min-h-screen bg-night text-ivory flex flex-col items-center py-14 px-6">
      ...
      >
        <h1 className="text-4xl md:text-5xl text-ivory mb-4 font-display font-normal tracking-tight">
      ...
      <div className="grid md:grid-cols-3 gap-6 max-w-5xl w-full mb-14">
        ...
        >
          <h3 className="text-xl font-semibold mb-2 text-gray-100">Total Return (YTD)</h3>
          <p className="text-3xl font-bold text-gold">+18.9%</p>
        ...
        <motion.div
          ...
          className="bg-surface2 border border-white/10 rounded-2xl shadow-md p-6 text-center"
        >
          <h3 className="text-xl font-semibold mb-2 text-gray-100">Sharpe Ratio</h3>
          <p className="text-3xl font-bold text-gold">1.42</p>
        ...
        <motion.div
          ...
          className="bg-surface2 border border-white/10 rounded-2xl shadow-md p-6 text-center"
        >
          <h3 className="text-xl font-semibold mb-2 text-gray-100">Win Rate</h3>
          <p className="text-3xl font-bold text-gold">73%</p>
      ...
      <div className="text-center">
        <h2 className="text-2xl font-semibold mb-3 text-ivory">
