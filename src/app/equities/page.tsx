...
// All US stocks — the /api/market/screener universe (top 1500 US-listed
// names by market cap, NYSE/Nasdaq/AMEX only). Search, sector filter and
// sorting are client-side; every row opens the symbol in /terminal.
  ...
  return (
    <main className="min-h-screen bg-night text-ivory">
      <div className="max-w-7xl mx-auto px-6 md:px-10 py-14 md:py-20">
        {/* Header */}
        <Reveal>
          <CommandLine cmd="EQS" note="all US stocks" className="mb-4" />
          <div className="flex flex-col gap-5 md:flex-row md:items-end md:justify-between">
            <div className="max-w-2xl">
              ...
              <p className="mt-4 text-gray-300">
                Every NYSE, Nasdaq and AMEX listing above $500M in market cap, with live price, volume and
                market cap. Click any row to open it in the Terminal.
              </p>
            </div>
        ...
        <Reveal delay={0.1} className="mt-10 md:mt-12">
          ...
          <p className="mt-4 font-monodata text-xs text-gray-500">
            Prices delayed or real-time depending on source · Not investment advice
          </p>
        </Reveal>
      </div>
    </main>
